...
*/
function getName(/* code here */user) {
  /* code here */
...
*/
function makeSmartPerson(/* code here */name, sum, speak) {
  /* code here */
  const object = {
    name: name,
 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(/* code here */inventory, number) {
  /* code here */
...
*/
function sortCarInventory(/* code here */inventory, car_model) {
  /* code here */
...
*/
function getOlderCars(/* code here */inventory, car_year) {
  /* code here */
  let oldCars = [];
...
function getGermanCars(/* code here */inventory) {
  ...
  for(let i = 0; i <inventory.length; i++) {
    ...
    || inventory[i].car_make === "Volkswagen" ||inventory[i].car_make === "BMW"){
      AudiBenzVolBMW.push(inventory[i]);
    }
  }
  return AudiBenzVolBMW;
}
